...
public class BedroomFragment extends BaseFragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.frag_bedroom, container, false);
        return mView;
    }
    ...
    private void initView() {
        btn = (Button) mView.findViewById(R.id.bedroom_button);
        text = (TextView) mView.findViewById(R.id.bedroom_textView);
    }
