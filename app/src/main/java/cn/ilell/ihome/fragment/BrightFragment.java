...
public class BrightFragment extends BaseFragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.frag_bright, container, false);
        return mView;
    }
    ...
    protected void initView() {
        btn = (Button) mView.findViewById(R.id.bright_button);
        text = (TextView) mView.findViewById(R.id.bright_textView);
    }
